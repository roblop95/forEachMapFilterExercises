...
function extractKey(arr, key){
    const arrKeys = arr.map(function(obj){
        if(obj[key]){
            return obj[key];
        }
    })
...
function extractFullName(arr){
    const arrNames = arr.map(function(obj){
...
function filterByValue(arr, key) {
    const filteredObjs = arr.filter(function(obj){
        return obj[key];
    })
...
function findInObj(arr, key, searchValue) {
    const arrFound = arr.filter(function(obj){
...
function removeVowels(str) {
    ...
    const arr = newStr.filter(function(letter){
